...
public class ScatterPassUpdater extends GameUpdater {
	
	private static ScatterPassUpdater instance;
	
	public static ScatterPassUpdater getInstance(){
		if (instance == null)
			instance = new ScatterPassUpdater();
		return instance;
	}
