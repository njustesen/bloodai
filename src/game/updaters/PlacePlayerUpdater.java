...
public class PlacePlayerUpdater extends GameUpdater {
	
	private static PlacePlayerUpdater instance;
	
	public static PlacePlayerUpdater getInstance(){
		if (instance == null)
			instance = new PlacePlayerUpdater();
		return instance;
	}
