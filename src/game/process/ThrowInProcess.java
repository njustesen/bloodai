...
public class ThrowInProcess extends GameProcess {
	
	private static ThrowInProcess instance;
	
	public static ThrowInProcess getInstance(){
		if (instance == null)
			instance = new ThrowInProcess();
		return instance;
	}
