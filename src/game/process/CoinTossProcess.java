...
public class CoinTossProcess extends GameProcess {
	
	private static CoinTossProcess instance;
	
	public static CoinTossProcess getInstance(){
		if (instance == null)
			instance = new CoinTossProcess();
		return instance;
	}
