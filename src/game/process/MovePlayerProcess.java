...
public class MovePlayerProcess extends GameProcess {
	
	private static MovePlayerProcess instance;
	
	public static MovePlayerProcess getInstance(){
		if (instance == null)
			instance = new MovePlayerProcess();
		return instance;
	}
