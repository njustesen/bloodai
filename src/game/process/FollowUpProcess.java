...
public class FollowUpProcess extends PushProcess {
	
	private static FollowUpProcess instance;
	
	public static FollowUpProcess getInstance(){
		if (instance == null)
			instance = new FollowUpProcess();
		return instance;
	}
