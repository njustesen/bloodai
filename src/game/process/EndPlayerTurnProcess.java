...
public class EndPlayerTurnProcess extends GameProcess {
	
	private static EndPlayerTurnProcess instance;
	
	public static EndPlayerTurnProcess getInstance(){
		if (instance == null)
			instance = new EndPlayerTurnProcess();
		return instance;
	}
