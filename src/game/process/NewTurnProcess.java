...
public class NewTurnProcess extends GameProcess {
	
	private static NewTurnProcess instance;
	
	public static NewTurnProcess getInstance(){
		if (instance == null)
			instance = new NewTurnProcess();
		return instance;
	}
