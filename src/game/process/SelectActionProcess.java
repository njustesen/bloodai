...
public class SelectActionProcess extends GameProcess {
	
	private static SelectActionProcess instance;
	
	public static SelectActionProcess getInstance(){
		if (instance == null)
			instance = new SelectActionProcess();
		return instance;
	}
